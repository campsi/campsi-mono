...
module.exports.createValidationToken = function(username, salt) {
    ...
    let user = {
        ...
        identities: {
            local: {
                ...
                validated: false,
                validationToken: module.exports.createValidationToken(req.body.username, salt)
            }
        }
    };
...
module.exports.validate = function(req, res) {
    ...
    req.db.collection('__users__').updateOne(
        ...
        if(out.result.nModified === 1) {
            ...
            return helpers.notFound(res, {message: 'Validation Token not found'});
        }
    }).catch(() => {
